...
blue.setPosition(6, 245, wait=True)
...
#take it out
blue.setPosition(6, 245, wait = True)
blue.setPosition(3, 910, wait = True)
blue.setPosition(4, 372, wait = True)
blue.setPosition(6, 521, wait = True)
blue.setPosition(5, 697, wait = True)
time.sleep(1.00)
